import { fetchRates, Query } from "../dist/parts/requester";
import { AxiosInstance, AxiosResponse, AxiosRequestHeaders } from "axios";
import { Provider } from "../dist/parts/providers";
import { sleep } from "../dist/parts/utils";

// Mock sleep to resolve immediately
jest.mock("../dist/parts/utils", () => {
  const actual = jest.requireActual("../dist/parts/utils");
  return {
    ...actual,
